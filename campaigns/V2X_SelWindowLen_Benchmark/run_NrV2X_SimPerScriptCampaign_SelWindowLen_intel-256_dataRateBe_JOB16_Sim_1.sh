...
mkdir -p /home/rqdfhsilva/ns-3-dev/results_intel-256_NrV2X_SimPerScriptCampaign_SelWindowLen_dataRateBe/JOB16/Sim_1
cp -f run_NrV2X_SimPerScriptCampaign_SelWindowLen_intel-256_dataRateBe_JOB16_Sim_1.sh /home/rqdfhsilva/ns-3-dev/results_intel-256_NrV2X_SimPerScriptCampaign_SelWindowLen_dataRateBe
